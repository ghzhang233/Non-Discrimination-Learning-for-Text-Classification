...
from keras.layers import Input, Dense, Embedding, LSTM, BatchNormalization, Dropout, concatenate, dot
...
def get_model(embedding,
    ...
    for j in range(num_lstm):
        lstm_layer = LSTM(dim_hidden, return_sequences=(j != num_lstm - 1))
